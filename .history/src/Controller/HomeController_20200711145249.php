...
class HomeController extends AbstractController
{
     ...
     */
    public function delete(Chambre $chambre, Request $request, ManagerRegistry $manager, EtudiantRepository $etudiant)
    {


        if ($this->isCsrfTokenValid('delete' . $chambre->getId(), $request->get('_token'))) {
            $chambreOccuper = $etudiant->findEtuByChambre($chambre->getId());
